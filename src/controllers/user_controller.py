...
from src.models.user_model import  contar_usuarios ,contar_total_usuarios, contar_usuarios_sedes, contar_estudiantes_activos
...
def count_estudiantes_activos():
    usuarios_activos = contar_estudiantes_activos()
